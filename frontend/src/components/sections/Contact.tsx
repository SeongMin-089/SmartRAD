    ...
    <section id="contact" className="w-full bg-[linear-gradient(180deg,#F4F8FF_0%,#FFFFFF_100%)] py-24 sm:py-32">
      <Container className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        <div className="flex min-h-[680px] flex-col rounded-[28px] bg-gradient-to-br from-[#17458F] via-[#1E55C7] to-[#246BFE] p-7 text-white sm:p-10">
          <SectionBadge variant="inverse" className="w-fit">문의</SectionBadge>
        ...
        <form onSubmit={handleSubmit} className="flex min-h-[680px] flex-col rounded-[28px] border border-brand-border bg-white p-7 shadow-[0_18px_45px_rgba(50,94,160,0.08)] sm:p-10">
          <h2 className="text-[25px] font-extrabold text-brand-navy">도입 문의 및 견적</h2>
          <p className="mt-4 text-[15px] font-bold text-brand-text">회사 규모와 필요한 기능을 기준으로 빠른 상담을 연결합니다.</p>
        ...
        <div className="rounded-[28px] border border-brand-border bg-white p-7 shadow-[0_18px_45px_rgba(50,94,160,0.06)] sm:p-8">
          <h2 className="text-[24px] font-extrabold text-brand-navy">자주 묻는 질문</h2>
          <p className="mt-3 text-[14px] font-bold text-brand-text">도입 전 고객들이 가장 많이 확인하는 항목을 한눈에 정리했습니다.</p>
        ...
        <div className="rounded-[28px] border border-brand-border bg-white p-7 shadow-[0_18px_45px_rgba(50,94,160,0.06)] sm:p-8">
          <h2 className="text-[24px] font-extrabold text-brand-navy">고객 센터</h2>
          <p className="mt-3 text-[14px] font-bold leading-6 text-brand-text">서비스 이용 가이드와 헬프데스크를 통해 도입 이후에도 안정적으로 운영할 수 있습니다.</p>
          <div className="mt-7 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="rounded-[16px] border border-[#D5E4FA] bg-[#F4F8FF] p-5"><h3 className="text-[15px] font-extrabold text-brand-navy">이용 가이드</h3><p className="mt-2 text-[12px] font-semibold leading-5 text-brand-text">관리자 설정, 직원 등록, 근태 관리 방법 안내</p></div>
            <div className="rounded-[16px] border border-[#D5E4FA] bg-[#F4F8FF] p-5"><h3 className="text-[15px] font-extrabold text-brand-navy">헬프데스크</h3><p className="mt-2 text-[12px] font-semibold leading-5 text-brand-text">도입, 결제, 기능 문의를 빠르게 접수</p></div>
          </div>
        </div>
      </Container>
    </section>
